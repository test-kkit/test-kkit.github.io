...
const vrmArray = [
  {
    "name": "egg",
    "url":"./egg.vrm",
    "cameraPosition": [0.0, 1.4, 5.0]
  },
  {
    "name": "lady",
    "url": "./lady.vrm",
    "cameraPosition": [0.0, 1.4, 0.7]
  },
  {
    "name": "rabbit",
    "url":"./rabbit.vrm",
...
let thistimeVrmConfig = vrmArray[Math.floor(Math.random() * vrmArray.length)];
...
orbitCamera.position.set(...thistimeVrmConfig["cameraPosition"]);
...
scene.background = new THREE.Color( 0xEFFFFD );
...
let vrmurl = thistimeVrmConfig["url"];
